define([
        ...
        'Rbofee_Extrafee/js/action/load-fees',
        'uiRegistry',
        'Rbofee_Conditions/js/model/subscriber'
    ], function(
        _,
        $,
        utils,
        ...
        return Component.extend({
            defaults: {
                ...
                components:
                {
                    dropdown: 'Rbofee_Extrafee/js/fee/item/dropdown',
                    checkbox: 'Rbofee_Extrafee/js/fee/item/checkbox',
                    radio: 'Rbofee_Extrafee/js/fee/item'
                }
            },
            /**
