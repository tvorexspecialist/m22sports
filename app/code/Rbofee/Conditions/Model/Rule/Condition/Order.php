...
class Order extends \Magento\SalesRule\Model\Rule\Condition\Product\Combine
{
    ...
    /**
     * @var \Rbofee\Conditions\Model\Order\ResourceModel\Collection
     */
    private $reportsFactory;

    public function __construct(
        \Magento\Rule\Model\Condition\Context $context,
        \Rbofee\Conditions\Model\Order\ResourceModel\CollectionFactory $reportsFactory,
        \Magento\SalesRule\Model\Rule\Condition\Product $ruleConditionProduct,
        array $data = []
    ) {
        parent::__construct($context, $ruleConditionProduct, $data);
        $this->setType(\Rbofee\Conditions\Model\Rule\Condition\Order::class)->setValue(null);
