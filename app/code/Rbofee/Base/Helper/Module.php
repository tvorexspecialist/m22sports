...
{
    const EXTENSIONS_PATH = 'rbobase_extensions';
    const URL_EXTENSIONS  = 'http://rbofee.com/feed-extensions-m2.xml';
    ...
    /**
     * Get array with info about all Rbofee Magento2 Extensions
     * @return bool|mixed
     */
