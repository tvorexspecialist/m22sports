...
namespace Rbofee\Conditions\Observer\Admin;
...
class AddNewConditionHandle implements \Magento\Framework\Event\ObserverInterface
{
    ...
    const CONDITION_MODEL_PATH = 'Rbofee\Conditions\Model\Rule\Condition\\';
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        foreach (self::CONDITIONS as $groupName => $customConditions) {
            ...
            if ($groupName === 'Advanced Conditions') {
                $attributes[] = [
                    'value' => \Rbofee\Conditions\Model\Rule\Condition\Order::class,
