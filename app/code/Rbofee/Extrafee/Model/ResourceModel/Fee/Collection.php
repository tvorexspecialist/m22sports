...
namespace Rbofee\Extrafee\Model\ResourceModel\Fee;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init('Rbofee\Extrafee\Model\Fee', 'Rbofee\Extrafee\Model\ResourceModel\Fee');
    ...
    protected function _afterLoad()
    {
        ...
        $this->performAfterLoad(
            'rbofee_extrafee_store',
            'rbofee_extrafee_entity_store',
        ...
        $this->performAfterLoad(
            ...
            'rbofee_extrafee_entity_customer_group',
            $entityMetadata->getLinkField(),
            'fee_id',
            'customer_group_id'
        );
    ...
    {
        $this->joinStoreRelationTable('rbofee_extrafee_store', 'fee_id');
        $this->joinGroupRelationTable('rbofee_extrafee_customer_group', 'fee_id');
    }
}