...
use Rbofee\Extrafee\Api\Data\FeeSearchResultsInterfaceFactory;
use Rbofee\Extrafee\Api\FeeRepositoryInterface;
use Rbofee\Extrafee\Api\Data\FeeInterface;
use Rbofee\Extrafee\Api\Data\FeeInterfaceFactory;
use Rbofee\Extrafee\Model\ResourceModel\Fee as ResourceFee;
...
use Rbofee\Extrafee\Model\QuoteFactory as QuoteFeeFactory;
...
class FeeRepository implements FeeRepositoryInterface
{
     ...
     * @param \Rbofee\Extrafee\Model\FeeFactory $feeFactory
    ...
    public function getList(
        ...
        /** @var \Rbofee\Extrafee\Model\ResourceModel\Fee\Grid\Collection $collection */
        ...
        foreach ($collection as $model) {
            ...
            if ($this->validateAddress($quote, $model)) {
                ...
                $this->dataObjectHelper->populateWithArray(
                    $itemData,
                    $model->getData(),
                    \Rbofee\Extrafee\Api\Data\FeeInterface::class
                );
    ...
    {
        /** @var \Rbofee\Extrafee\Model\ResourceModel\Fee\Collection $feeCollection */
        $feeCollection = $this->feeCollectionFactory->create();

        $fees = $feeCollection->getItems();
        $feeArray = [];
        /** @var \Rbofee\Extrafee\Model\Fee $fee */
        foreach ($fees as $fee) {
    ...
    public function getByOptionId($optionId)
    {
        ...
        $tableName = $this->resource->getTable('rbofee_extrafee_option');
