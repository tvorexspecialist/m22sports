    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (!$installer->tableExists('mageplaza_abandonedcart_logs')) {
            $table = $installer->getConnection()
                ...
                ->addColumn('quote_id', Table::TYPE_INTEGER, null, ['unsigned' => true, 'nullable' => false, 'default' => '0'], 'Quote Id')
                ->addColumn('sequent_number', Table::TYPE_SMALLINT, null, ['unsigned' => true, 'nullable' => false, 'default' => '1'], 'Sequent number')
                ->addColumn('recovery', Table::TYPE_SMALLINT, null, ['unsigned' => true, 'nullable' => false, 'default' => '0'], 'Recovery')
        ...
        if (!$installer->tableExists('mageplaza_abandonedcart_logs_token')) {
            $table = $installer->getConnection()
                ...
                ->addColumn('checkout_token', Table::TYPE_TEXT, 128, ['nullable' => true, 'default' => null], 'Checkout token')
                ->addColumn('checkout_token_created_at', Table::TYPE_DATETIME, null, ['nullable' => true, 'default' => null], 'Checkout token creation time')
                ->addIndex(
