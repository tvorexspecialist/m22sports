...
{
    /** @var \Rbofee\Extrafee\Model\Config\Source\Excludeinclude  */
     ...
     * @param \Rbofee\Extrafee\Model\Config\Source\Excludeinclude $excludeincludeSource
     * @param array $data
     */
    public function __construct(
        ...
        \Rbofee\Extrafee\Model\Config\Source\Excludeinclude $excludeincludeSource,
        array $data = []
    ){
    ...
    protected function _prepareForm()
    {
        ...
        if (!$model->getId()){
            $model->setData([
                'discount_in_subtotal' => \Rbofee\Extrafee\Model\Config\Source\Excludeinclude::VAR_DEFAULT,
                'tax_in_subtotal' => \Rbofee\Extrafee\Model\Config\Source\Excludeinclude::VAR_DEFAULT,
                'shipping_in_subtotal' => \Rbofee\Extrafee\Model\Config\Source\Excludeinclude::VAR_DEFAULT
            ]);
        }
