...
namespace Rbofee\Conditions\Model\Rule\Condition;

use Rbofee\Conditions\Model\Constants;
...
class CustomerAttributes extends \Magento\Rule\Model\Condition\AbstractCondition
{
    ...
    /**
     * @var \Rbofee\Conditions\Model\Address
     */
    private $address;
    ...
    public function __construct(
        ...
        \Rbofee\Conditions\Model\Address $address,
        array $data = []
    ) {
     ...
     *
     * @return \Rbofee\Conditions\Model\Rule\Condition\CustomerAttributes
     */
    ...
    private function getInputTypeFromAttribute($customerAttribute)
    {
        ...
        switch ($customerAttribute->getFrontendInput()) {
            case 'gallery':
            case 'media_image':
            case 'selectimg': // rbofee customer attribute
                return 'select';

            case 'multiselectimg': // rbofee customer attribute
                return 'multiselect';
        }
