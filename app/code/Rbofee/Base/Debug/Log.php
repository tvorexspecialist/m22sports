...
class Log
{
     ...
     * @var string
     */
    private static $fileToLog = 'rbofee_debug.log';
...
%message%
----------------------------------------------------------------------------\n\n";
        $formatter = new System\RbofeeFormatter($output);

        $handler->setFormatter($formatter);
        self::$loggerInstance = new \Magento\Framework\Logger\Monolog('rbofee_logger', [$handler]);
    }
}
